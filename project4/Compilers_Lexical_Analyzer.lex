...
{EQ}				{yylval.relop = yytext; printresult("EQ",EQ);return EQ;}
...
\".*\"			{yylval.string = fetchIndex(yytext,yyleng);printresult(yytext,STRING);return STRING;}
	/*Indentifier Match */
...
{relop}				{yylval.relop = yytext; printresult(yytext,RELOP);return RELOP;}
	/*comments Match*/
\{[^\}]*\}		;
